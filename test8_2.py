...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        if test_l[epoch] < test_l_best:
            ...
            torch.save(encoder.state_dict(), '8_2_2classbest_combRes50_randint_lr1_bs32_acrossSub_run2.params')
            torch.save(CombNet.state_dict(), '8_2_2cnnbest_combRes50_randint_lr1_bs32_acrossSub_run2.params')
    torch.save([train_l, test_l], '8_2_2loss_combRes50_randint_lr1_bs32_acrossSub_run2.data1')
    torch.save(CombNet.state_dict(), '8_2_2end_combRes50_randint_lr1_bs32_acrossSub_run2.params')
    ...
    with torch.no_grad():
        CNNnet = resnet50(classification=False)
        CombNet = Combine(CNNnet, input_size=384 * 4, device=device, batch_first=True)
        CombNet.load_state_dict(torch.load('/home/yuandy/code/self-super/nihe/crossdata_acc/8_2_2cnnbest_combRes50_randint_lr1_bs32_acrossSub_run2.params'))
        CombNet.eval()
        CombNet.to(device)
        encoder = Encoder()
        encoder.load_state_dict(torch.load('/home/yuandy/code/self-super/nihe/crossdata_acc/8_2_2classbest_combRes50_randint_lr1_bs32_acrossSub_run2.params'))
        encoder.to(device)
        encoder.eval()
        ...
        plt.savefig('8_2_2.eps', dpi=400, bbox_inches='tight')
        plt.figure(dpi=400)
