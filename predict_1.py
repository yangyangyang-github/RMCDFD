...
if __name__ == '__main__':
    writer = SummaryWriter("/home/yuandy/code/self-super/nihe/crossdata_acc/logs1")
    ...
    for epoch in range(num_epochs):
        ...
        if test_l[epoch] < test_l_best:
            ...
            torch.save(encoder.state_dict(), '1classbest_combRes50_randint_lr1_bs32_acrossSub_run2.params')
            torch.save(CombNet.state_dict(), '1cnnbest_combRes50_randint_lr1_bs32_acrossSub_run2.params')
    torch.save([train_l,test_l],'1loss_combRes50_randint_lr1_bs32_acrossSub_run2.data1')
    torch.save(CombNet.state_dict(), '1end_combRes50_randint_lr1_bs32_acrossSub_run2.params')
